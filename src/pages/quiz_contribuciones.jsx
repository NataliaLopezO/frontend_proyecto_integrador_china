                ...
                <div className="centered-div">
                    ...
                    {preguntas.map((item) => (
                        <div key={item.id}>
                            ...
                            <strong><p className="centered-div">{item.pregunta}</p></strong>
                            <input type="checkbox" onChange={() => { selectOption(item.opcion1.es_respuesta_correcta); }}/> {item.opcion1.texto_opcion}<br></br>
                            <input type="checkbox" onChange={() => { selectOption(item.opcion2.es_respuesta_correcta); }}/> {item.opcion2.texto_opcion}<br></br>
                            <input type="checkbox" onChange={() => { selectOption(item.opcion3.es_respuesta_correcta); }}/> {item.opcion3.texto_opcion}<br></br>
                    ...
                    <Modal show={mensajeVisible} onHide={() => setMensajeVisible(false)}>
                        ...
                        <Modal.Footer>
                            <Button variant="secondary" onClick={() => setMensajeVisible(false)}>
                                Cerrar
                            </Button>
                        </Modal.Footer>
                    </Modal>
